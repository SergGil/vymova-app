...
import {
  resetLobbyUI as resetLobbyStore,
  setLobbyWaiting,
  setLobbyMsg,
...
describe('duel-lobby.tsx DuelLobby', () => {
  ...
  it('the create button calls createRoom', () => {
    ...
    roots.push(root);
    act(() => {
      (container.querySelector('#duel-create-btn') as HTMLButtonElement).click();
    });
  ...
  it('shows the waiting panel with room code when waiting for an opponent', () => {
    ...
    act(() => {
      (container.querySelector('#duel-cancel-btn') as HTMLButtonElement).click();
    });
  ...
  it('formats and submits the join code', () => {
    ...
    act(() => {
      (container.querySelector('#duel-join-btn') as HTMLButtonElement).click();
    });
