        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 7, marginBottom: 8 }}>
            {round.choices.map((c, i) => {
              ...
              if (selected !== null) {
                if (i === selected) cls += i === round.oddIndex ? ' correct border-[var(--quiz-correct-border)]! bg-[var(--quiz-correct-bg)]! text-[var(--quiz-correct-color)]! font-semibold' : ' wrong border-[var(--quiz-wrong-border)]! bg-[var(--quiz-wrong-bg)]! text-[var(--quiz-wrong-color)]!';
                else if (i === round.oddIndex) cls += ' reveal border-[var(--quiz-reveal-border)]! bg-[var(--quiz-reveal-bg)]! text-[var(--quiz-reveal-color)]! opacity-70';
              }
              return (
                <button
                  key={c.entry[0]}
