        ...
        <>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 7 }}>
            {step.options.map((opt, i) => {
              ...
              if (selected) {
                if (opt === selected) cls += opt === step.correct ? ' correct !border-[var(--quiz-correct-border)] !bg-[var(--quiz-correct-bg)] !text-[var(--quiz-correct-color)] font-semibold' : ' wrong !border-[var(--quiz-wrong-border)] !bg-[var(--quiz-wrong-bg)] !text-[var(--quiz-wrong-color)]';
                else if (opt === step.correct) cls += ' reveal !border-[var(--quiz-reveal-border)] !bg-[var(--quiz-reveal-bg)] !text-[var(--quiz-reveal-color)] opacity-70';
              }
              return (
