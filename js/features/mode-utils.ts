...
const LANG_LOADERS: Record<TargetLang, () => Promise<Table>> = {
  ...
  so: () => import('../../data/words_so.js').then((m) => m.W_SO as Table),
  ha: () => import('../../data/words_ha.js').then((m) => m.W_HA as Table),
  yo: () => import('../../data/words_yo.js').then((m) => m.W_YO as Table),
  ig: () => import('../../data/words_ig.js').then((m) => m.W_IG as Table),
  ti: () => import('../../data/words_ti.js').then((m) => m.W_TI as Table),
  wo: () => import('../../data/words_wo.js').then((m) => m.W_WO as Table),
  mg: () => import('../../data/words_mg.js').then((m) => m.W_MG as Table),
  xh: () => import('../../data/words_xh.js').then((m) => m.W_XH as Table),
  sn: () => import('../../data/words_sn.js').then((m) => m.W_SN as Table),
  ny: () => import('../../data/words_ny.js').then((m) => m.W_NY as Table),
  fj: () => import('../../data/words_fj.js').then((m) => m.W_FJ as Table),
  sm: () => import('../../data/words_sm.js').then((m) => m.W_SM as Table),
  to: () => import('../../data/words_to.js').then((m) => m.W_TO as Table),
  mi: () => import('../../data/words_mi.js').then((m) => m.W_MI as Table),
  ...
  yi: () => import('../../data/words_yi.js').then((m) => m.W_YI as Table),
  lad: () => import('../../data/words_lad.js').then((m) => m.W_LAD as Table),
  qu: () => import('../../data/words_qu.js').then((m) => m.W_QU as Table),
  gn: () => import('../../data/words_gn.js').then((m) => m.W_GN as Table),
  ay: () => import('../../data/words_ay.js').then((m) => m.W_AY as Table),
  dz: () => import('../../data/words_dz.js').then((m) => m.W_DZ as Table),
  ...
  ku: () => import('../../data/words_ku.js').then((m) => m.W_KU as Table),
  om: () => import('../../data/words_om.js').then((m) => m.W_OM as Table),
  ln: () => import('../../data/words_ln.js').then((m) => m.W_LN as Table),
  bho: () => import('../../data/words_bho.js').then((m) => m.W_BHO as Table),
  ceb: () => import('../../data/words_ceb.js').then((m) => m.W_CEB as Table),
  rm: () => import('../../data/words_rm.js').then((m) => m.W_RM as Table),
  ty: () => import('../../data/words_ty.js').then((m) => m.W_TY as Table),
  ch: () => import('../../data/words_ch.js').then((m) => m.W_CH as Table),
  mh: () => import('../../data/words_mh.js').then((m) => m.W_MH as Table),
  pau: () => import('../../data/words_pau.js').then((m) => m.W_PAU as Table),
