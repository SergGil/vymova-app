  ...
  return (
    ...
    >
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '.65rem', color: 'var(--text3)', marginTop: 1 }}>
          {d.myIdx}/{d.myTotal}
        </div>
        <div style={{ marginTop: 3 }}>
          <Dots idx={d.myIdx} flags={d.myFlags} total={d.myTotal} color="var(--accent)" />
        </div>
      </div>
      <div style={{ textAlign: 'center' }}>
        <div
          style={{ fontSize: '.72rem', fontWeight: 700, color: 'var(--accent)', marginBottom: 2 }}
        >
          {mInfo.icon} {t('duel.mode.' + d.mode)}
        </div>
        {d.bestOf !== 1 && (
          <div
            style={{
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <div style={{ fontSize: '1.5rem', fontWeight: 800, color: 'var(--accent2)' }}>
          {d.oppScore}
        </div>
        ...
        <div style={{ marginTop: 3 }}>
          <Dots idx={d.oppIdx} flags={d.oppFlags} total={d.oppTotal} color="var(--accent2)" />
        </div>
      </div>
    </div>
  );
