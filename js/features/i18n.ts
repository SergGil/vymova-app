...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  'pos.n':              { ua: 'іменник',                            en: 'noun',                                es: 'sustantivo' },
  'pos.v':              { ua: 'дієслово',                           en: 'verb',                                es: 'verbo' },
  'pos.adj':            { ua: 'прикметник',                         en: 'adjective',                           es: 'adjetivo' },
  'pos.adv':            { ua: 'прислівник',                         en: 'adverb',                              es: 'adverbio' },
  'pos.pron':           { ua: 'займенник',                          en: 'pronoun',                             es: 'pronombre' },
  'pos.prep':           { ua: 'прийменник',                         en: 'preposition',                         es: 'preposición' },
  'pos.conj':           { ua: 'сполучник',                          en: 'conjunction',                         es: 'conjunción' },
  'pos.interj':         { ua: 'вигук',                              en: 'interjection',                        es: 'interjección' },
  'pos.det':            { ua: 'займенник',                          en: 'determiner',                          es: 'determinante' },
  'pos.num':            { ua: 'числівник',                          en: 'numeral',                             es: 'numeral' },
  'pos.phrase':         { ua: 'вираз',                              en: 'phrase',                              es: 'expresión' },
  ...
  'wd.learned':       { ua: '✓ Вивчено',          en: '✓ Learned',          es: '✓ Aprendido' },
  'wd.reviewNow':     { ua: 'Повторити зараз',     en: 'Review now',         es: 'Repasar ahora' },
  'wd.tomorrow':      { ua: 'Завтра',              en: 'Tomorrow',           es: 'Mañana' },
  'wd.inDays':        { ua: 'Через {n} дн.',       en: 'In {n} days',        es: 'En {n} días' },
  'wd.repsCount':     { ua: '{n} повторень',       en: '{n} reviews',        es: '{n} repasos' },
  ...
  'pron.perfect.title':    { ua: 'Ідеально!',          en: 'Perfect!',           es: '¡Perfecto!' },
  'pron.perfect.sub':      { ua: 'Вимова як у носія',  en: 'Native-like pronunciation', es: 'Pronunciación como nativo' },
  'pron.good.title':       { ua: 'Добре!',             en: 'Good!',              es: '¡Bien!' },
  'pron.good.sub':         { ua: 'Майже ідеально',     en: 'Almost perfect',     es: 'Casi perfecto' },
  'pron.okay.title':       { ua: 'Непогано',           en: 'Not bad',            es: 'No está mal' },
  'pron.okay.sub':         { ua: 'Ти: "{s}"',          en: 'You: "{s}"',         es: 'Tú: "{s}"' },
  'pron.tryAgain.title':   { ua: 'Спробуй знову',      en: 'Try again',          es: 'Inténtalo de nuevo' },
  'pron.unsupported.title': { ua: 'Не підтримується',  en: 'Not supported',      es: 'No es compatible' },
  'pron.unsupported.sub':  { ua: 'Спробуй Chrome',     en: 'Try Chrome',         es: 'Prueba Chrome' },
  'pron.error.title':      { ua: 'Помилка',            en: 'Error',              es: 'Error' },
  'pron.error.sub':        { ua: 'Перевір мікрофон',   en: 'Check your microphone', es: 'Revisa tu micrófono' },
  'notif.streak.title':    { ua: '🔥 Серія під загрозою!', en: '🔥 Your streak is at risk!', es: '🔥 ¡Tu racha está en riesgo!' },
  'notif.streak.body':     { ua: '{n} днів підряд — не зупиняйся сьогодні!', en: '{n} days in a row — don\'t stop today!', es: '¡{n} días seguidos, no pares hoy!' },
  'notif.due.title':       { ua: '📚 {n} слів чекають повторення', en: '📚 {n} words are due for review', es: '📚 {n} palabras esperan repaso' },
  'notif.due.body':        { ua: 'Відкрий English Words і повтори їх!', en: 'Open English Words and review them!', es: '¡Abre English Words y repásalas!' },
  'notif.daily.title':     { ua: '📖 Час вчити слова!', en: '📖 Time to learn words!', es: '📖 ¡Hora de aprender palabras!' },
  'notif.daily.body':      { ua: 'Відкрий English Words — пара хвилин на слова і готово!', en: 'Open English Words — a couple of minutes and you\'re done!', es: '¡Abre English Words, un par de minutos y listo!' },
  ...
  'epub.readingStruct': { ua: 'Читаємо структуру…',            en: 'Reading structure…',               es: 'Leyendo estructura…' },
  'epub.error':         { ua: 'Помилка: ',                     en: 'Error: ',                          es: 'Error: ' },
  'epub.noContainer':   { ua: 'Не знайдено META-INF/container.xml', en: 'META-INF/container.xml not found', es: 'No se encontró META-INF/container.xml' },
  'epub.noOpf':         { ua: 'OPF файл не знайдено',          en: 'OPF file not found',               es: 'Archivo OPF no encontrado' },
  'epub.readingToc':    { ua: 'Читаємо зміст книги…',          en: 'Reading table of contents…',       es: 'Leyendo el índice del libro…' },
  'epub.opfNotOpened':  { ua: 'OPF файл не відкрито: ',        en: 'OPF file could not be opened: ',   es: 'No se pudo abrir el archivo OPF: ' },
  'epub.noChapters':    { ua: 'Немає розділів у книзі',        en: 'No chapters found in the book',    es: 'No se encontraron capítulos en el libro' },
  'epub.readingChapters': { ua: 'Читаємо {n} розділів…',       en: 'Reading {n} chapters…',            es: 'Leyendo {n} capítulos…' },
  'epub.chapterProgress': { ua: 'Розділ {i} / {n}',            en: 'Chapter {i} / {n}',                es: 'Capítulo {i} / {n}' },
  'epub.processingText': { ua: 'Обробляємо текст…',            en: 'Processing text…',                 es: 'Procesando texto…' },
  'offline.banner':     { ua: '📡 Немає підключення · Застосунок працює в офлайн режимі', en: '📡 No connection · App is running offline', es: '📡 Sin conexión · La aplicación funciona sin conexión' },
  'offline.restored':   { ua: '✅ Підключення відновлено',                en: '✅ Connection restored',              es: '✅ Conexión restaurada' },
  'offline.image.label': { ua: 'Офлайн',                                 en: 'Offline',                            es: 'Sin conexión' },
  'offline.image.unavailable': { ua: 'зображення недоступне',            en: 'image unavailable',                  es: 'imagen no disponible' },
  'goal.modal.title':   { ua: '🎯 Денна ціль',                       en: '🎯 Daily goal',                       es: '🎯 Meta de hoy' },
  'goal.modal.desc':    { ua: 'Скільки слів вивчити за день?',       en: 'How many words to learn per day?',    es: '¿Cuántas palabras aprender al día?' },
  'goal.modal.cancel':  { ua: 'Відміна',                             en: 'Cancel',                              es: 'Cancelar' },
  'goal.modal.save':    { ua: 'Зберегти',                            en: 'Save',                                es: 'Guardar' },
  ...
  'stats.perDayTitle':      { ua: 'Слів вивчено по днях',                  en: 'Words learned per day',                      es: 'Palabras aprendidas por día' },
  'stats.perDayCount':      { ua: '(останні {n} днів)',                    en: '(last {n} days)',                            es: '(últimos {n} días)' },
  ...
  'settings.bugTitle':          { ua: '🐛 Повідомити про помилку',       en: '🐛 Report a bug',                    es: '🐛 Reportar un error' },
  'settings.bugDesc':           { ua: 'Знайшли помилку або є пропозиція?', en: 'Found a bug or have a suggestion?',  es: '¿Encontraste un error o tienes una sugerencia?' },
  'settings.bugSubjectDefault': { ua: '— Оберіть тему —',                 en: '— Select a subject —',               es: '— Elige un tema —' },
  'settings.bugSubjectData':    { ua: '📊 Помилка в даних',               en: '📊 Error in word data',              es: '📊 Error en los datos' },
  'settings.bugSubjectTech':    { ua: '🐛 Технічна проблема',             en: '🐛 Technical issue',                 es: '🐛 Problema técnico' },
  'settings.bugSubjectIdea':    { ua: '💡 Пропозиція / ідея',             en: '💡 Suggestion / idea',               es: '💡 Sugerencia / idea' },
  'settings.bugSubjectOther':   { ua: '❓ Інше',                          en: '❓ Other',                           es: '❓ Otro' },
  'settings.bugPlaceholder':    { ua: 'Опишіть проблему…',                en: 'Describe the issue…',                es: 'Describe el problema…' },
  'settings.bugSendBtn':        { ua: '📨 Надіслати',                     en: '📨 Send',                            es: '📨 Enviar' },
  'settings.bugSentNote':       { ua: 'Відкриваємо поштовий клієнт…',     en: 'Opening email client…',              es: 'Abriendo el cliente de correo…' },
  ...
  'export.noWordsAlert':  { ua: 'Немає слів для експорту. Змініть фільтр.', en: 'No words to export. Change the filter.', es: 'No hay palabras para exportar. Cambia el filtro.' },
  'export.filter.known':   { ua: 'вивчені',  en: 'known',   es: 'aprendidas' },
  'export.filter.unknown': { ua: 'невивчені', en: 'unknown', es: 'no aprendidas' },
  'export.filter.all':     { ua: 'всі',      en: 'all',     es: 'todas' },
  'export.filter.custom':  { ua: 'власні',   en: 'custom',  es: 'propias' },
  'export.pdf.wordCol':    { ua: 'Слово / IPA', en: 'Word / IPA', es: 'Palabra / IPA' },
  'export.pdf.translCol':  { ua: 'Переклад',    en: 'Translation', es: 'Traducción' },
  'export.pdf.exampleCol': { ua: 'Приклад',     en: 'Example',     es: 'Ejemplo' },
  'export.pdf.wordsSuffix':{ ua: 'слів',        en: 'words',       es: 'palabras' },
  'share.title':         { ua: 'English Words — мій прогрес', en: 'English Words — my progress', es: 'English Words — mi progreso' },
  'share.copied':        { ua: '✅ Скопійовано!', en: '✅ Copied!', es: '✅ ¡Copiado!' },
  'share.copyPrompt':    { ua: 'Скопіюй цей код:', en: 'Copy this code:', es: 'Copia este código:' },
  'csv.imported':        { ua: '✅ Імпортовано {n} слів', en: '✅ Imported {n} words', es: '✅ Se importaron {n} palabras' },
  'csv.skippedSuffix':   { ua: ' (пропущено {n})', en: ' (skipped {n})', es: ' (omitidas {n})' },
  'csv.noNewWords':      { ua: '⚠️ Не знайдено нових слів (пропущено {n})', en: '⚠️ No new words found (skipped {n})', es: '⚠️ No se encontraron palabras nuevas (omitidas {n})' },
  ...
  'ob.slide1.html':  {
    ua: 'Це твій персональний тренажер для вивчення <b>англійської лексики</b>. Тут <b>{n} слів</b> з прикладами, вимовою та перекладом.<br><br>Вчи по трохи щодня — і прогрес не змусить чекати!',
    en: 'This is your personal trainer for learning <b>English vocabulary</b>. There are <b>{n} words</b> with examples, pronunciation, and translations.<br><br>Learn a little every day — progress won\'t keep you waiting!',
    es: 'Este es tu entrenador personal para aprender <b>vocabulario en inglés</b>. Hay <b>{n} palabras</b> con ejemplos, pronunciación y traducción.<br><br>¡Aprende un poco cada día y el progreso no tardará en llegar!',
  },
  'ob.slide2.title': { ua: 'Як вчити слова', en: 'How to learn words', es: 'Cómo aprender palabras' },
  'ob.slide2.html':  { ua: 'Картка показує слово. Подумай, натисни щоб побачити переклад.', en: 'The card shows a word. Think, then tap to see the translation.', es: 'La tarjeta muestra una palabra. Piensa y toca para ver la traducción.' },
  'ob.slide2.tip1':  { ua: '<b>Знаю</b> — слово потрапить у систему повторень', en: '<b>Know</b> — the word goes into the spaced-repetition system', es: '<b>Lo sé</b> — la palabra entra en el sistema de repetición espaciada' },
  'ob.slide2.tip2':  { ua: '<b>Далі</b> — пропустити, побачиш знову', en: '<b>Next</b> — skip it, you\'ll see it again', es: '<b>Siguiente</b> — sáltala, la verás de nuevo' },
  'ob.slide2.tip3':  { ua: '<b>Свайп вгору</b> — показати переклад одразу', en: '<b>Swipe up</b> — show the translation right away', es: '<b>Deslizar hacia arriba</b> — mostrar la traducción al instante' },
  'ob.slide2.tip4':  { ua: '<b>SRS</b> — розумна система інтервалів', en: '<b>SRS</b> — smart interval system', es: '<b>SRS</b> — sistema inteligente de intervalos' },
  'ob.slide3.title': { ua: '10 режимів навчання', en: '10 learning modes', es: '10 modos de aprendizaje' },
  'ob.slide3.html':  { ua: 'Окрім карток є багато способів практикуватись:', en: 'Besides flashcards, there are many ways to practice:', es: 'Además de las tarjetas, hay muchas formas de practicar:' },
  'ob.slide3.tip1':  { ua: '<b>Тест</b> — обери з 4 варіантів', en: '<b>Quiz</b> — choose from 4 options', es: '<b>Test</b> — elige entre 4 opciones' },
  'ob.slide3.tip2':  { ua: '<b>Письмо</b> — введи переклад', en: '<b>Writing</b> — type the translation', es: '<b>Escritura</b> — escribe la traducción' },
  'ob.slide3.tip3':  { ua: '<b>Слухай</b> — розпізнай слово на слух', en: '<b>Listen</b> — recognize the word by ear', es: '<b>Escucha</b> — reconoce la palabra de oído' },
  'ob.slide3.tip4':  { ua: '<b>Темп</b> — гонка з таймером', en: '<b>Speed</b> — race against the timer', es: '<b>Ritmo</b> — carrera contrarreloj' },
  'ob.slide4.title': { ua: 'З чого почнемо?', en: 'Where shall we start?', es: '¿Por dónde empezamos?' },
  'ob.slide4.html':  { ua: 'Як хочеш починати? Обери підхід — завжди можна змінити у фільтрі.', en: 'How would you like to start? Pick an approach — you can always change it in the filter.', es: '¿Cómo quieres empezar? Elige un enfoque, siempre puedes cambiarlo en el filtro.' },
  'ob.level.srs.name':       { ua: 'SRS режим', en: 'SRS mode', es: 'Modo SRS' },
  'ob.level.srs.words':      { ua: 'система сама підбирає слова', en: 'the system picks words for you', es: 'el sistema elige las palabras por ti' },
  'ob.level.srs.hint':       { ua: '★ Рекомендовано', en: '★ Recommended', es: '★ Recomendado' },
  'ob.level.unlearned.name':  { ua: 'Тільки невивчені', en: 'Unlearned only', es: 'Solo no aprendidas' },
  'ob.level.unlearned.words': { ua: 'слова без позначки «Знаю»', en: 'words not marked "Know"', es: 'palabras sin marcar "Lo sé"' },
  'ob.level.unlearned.hint':  { ua: 'Фокус на нових словах', en: 'Focus on new words', es: 'Enfoque en palabras nuevas' },
  'ob.level.all.name':   { ua: 'Всі {n} слів', en: 'All {n} words', es: 'Todas las {n} palabras' },
  'ob.level.all.words':  { ua: 'повний словник одразу', en: 'the full dictionary at once', es: 'todo el diccionario de una vez' },
  'ob.level.all.hint':   { ua: 'Максимальне занурення', en: 'Maximum immersion', es: 'Inmersión máxima' },
  'ob.level.daily.name':  { ua: 'Місія дня', en: 'Daily mission', es: 'Misión diaria' },
  'ob.level.daily.words': { ua: '10 слів + таймер', en: '10 words + timer', es: '10 palabras + temporizador' },
  'ob.level.daily.hint':  { ua: 'Щоденний челендж', en: 'Daily challenge', es: 'Desafío diario' },
  'ob.skip':  { ua: 'Пропустити', en: 'Skip', es: 'Omitir' },
  'ob.next':  { ua: 'Далі →', en: 'Next →', es: 'Siguiente →' },
  'ob.start': { ua: '🚀 Почати навчання!', en: '🚀 Start learning!', es: '🚀 ¡Empezar a aprender!' },
};
