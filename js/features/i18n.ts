...
const DICT: Record<string, Record<Lang, string>> = {
  ...
  'hints.quiz':    { ua: '🧠 Тест: оберіть правильний переклад з 4 варіантів. Клавіші 1–4 для швидкого вибору.', en: '🧠 Quiz: pick the correct translation from 4 options. Keys 1–4 for quick selection.' },
  'hints.write':   { ua: '✍️ Письмо: введіть переклад англійською. 💡 — підказка, 🎤 — голосовий ввід.', en: '✍️ Write: type the translation in English. 💡 — hint, 🎤 — voice input.' },
  'hints.listen':  { ua: '🔊 Аудіо: натисніть ▶ щоб прослухати слово, потім оберіть переклад. Пробіл = повторити.', en: '🔊 Listening: press ▶ to hear the word, then pick the translation. Space = repeat.' },
  'hints.fib':     { ua: '✏️ Речення: введіть пропущене слово в речення. Enter — підтвердити, 💡 — підказка.', en: '✏️ Sentences: type the missing word in the sentence. Enter — submit, 💡 — hint.' },
  'hints.tempo':   { ua: '⚡ Темп: відповідайте якнайшвидше до кінця таймера. Клавіші 1–4 для вибору.', en: '⚡ Tempo: answer as fast as you can before the timer ends. Keys 1–4 to select.' },
  'hints.lesson':  { ua: '📚 Урок: 3 фази — флешкарти, тест, письмо. Пройдіть всі 5 слів щоб завершити.', en: '📚 Lesson: 3 phases — flashcards, quiz, writing. Complete all 5 words to finish.' },
  'hints.daily':   { ua: '📅 Місія дня: 10 слів з таймером 2 хв. Бонусні XP за кожну правильну відповідь!', en: '📅 Daily mission: 10 words with a 2-minute timer. Bonus XP for every correct answer!' },
  'hints.reading': { ua: '📖 Читання: кольорові слова — невивчені. Натисніть на слово щоб побачити переклад.', en: '📖 Reading: colored words are not yet learned. Click a word to see its translation.' },

  'keys.title':            { ua: '⌨️ Клавіатурні скорочення',     en: '⌨️ Keyboard shortcuts' },
  'keys.mainScreen':       { ua: 'Головний екран',                en: 'Main screen' },
  'keys.nextCard':         { ua: 'Наступна картка',               en: 'Next card' },
  'keys.markKnown':        { ua: 'Позначити "Знаю"',              en: 'Mark as "Known"' },
  'keys.navigation':       { ua: 'Навігація',                     en: 'Navigation' },
  'keys.showTranslation':  { ua: 'Показати переклад',             en: 'Show translation' },
  'keys.search':           { ua: 'Пошук',                         en: 'Search' },
  'keys.theseHints':       { ua: 'Ці підказки',                   en: 'These hints' },
  'keys.quizTempo':        { ua: 'Тест / Темп-режим',             en: 'Quiz / Tempo mode' },
  'keys.selectOption':     { ua: 'Вибір варіанту',                en: 'Select option' },
  'keys.nextAfterAnswer':  { ua: 'Далі (після відповіді)',        en: 'Next (after answering)' },
  'keys.repeatSound':      { ua: 'Повторити звук (Темп)',         en: 'Repeat sound (Tempo)' },
  'keys.close':            { ua: 'Закрити',                       en: 'Close' },
  'keys.writeFib':         { ua: 'Письмо / Пропуск',              en: 'Write / Fill-in-blank' },
  'keys.checkAnswer':      { ua: 'Перевірити відповідь',          en: 'Check answer' },
  'keys.nextAfterCheck':   { ua: 'Далі (після перевірки)',        en: 'Next (after checking)' },
  'keys.hint':             { ua: 'Підказка',                      en: 'Hint' },
  'keys.autocomplete':     { ua: 'Автодоповнення (Письмо)',       en: 'Autocomplete (Write)' },
  'keys.listening':        { ua: 'Слухання',                      en: 'Listening' },
  'keys.repeatWord':       { ua: 'Повторити слово',               en: 'Repeat word' },
  'keys.global':           { ua: 'Глобальні',                     en: 'Global' },
  'keys.closeAnyModal':    { ua: 'Закрити будь-який модал',       en: 'Close any modal' },
  'keys.searchInList':     { ua: 'Пошук у списку (стрілки)',      en: 'Search in list (arrows)' },
  'keys.space':            { ua: 'Пробіл',                        en: 'Space' },
  'keys.hintBtnKbd':       { ua: '💡 кнопка',                     en: '💡 button' },
