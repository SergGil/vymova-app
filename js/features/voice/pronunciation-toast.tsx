// Vymova — js/features/voice/pronunciation-toast.tsx
...
export function PronunciationToast(): ReactElement {
  ...
  return createPortal(
    ...
    >
      ...
      <div style={{ fontSize: '.72rem', opacity: 0.88 }}>{data.subtitle}</div>
      {data.pct > 0 && (
        <div
          style={{
            marginTop: 6,
        ...
        >
          <div
            style={{ width: `${data.pct}%`, height: '100%', background: '#fff', borderRadius: 4 }}
          />
        </div>
      )}
    </div>,
