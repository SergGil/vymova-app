// Vymova — js/features/duel/duel-lobby.tsx
...
export function DuelLobby(): ReactElement {
  ...
  return (
    <div id="duel-lobby">
        ...
        >
          {d.msg.challenge ? (
            <span style={{ color: 'var(--accent)' }}>
              📬 {d.msg.challenge.avatar} <b>{d.msg.challenge.name}</b> · {d.msg.challenge.modeIcon}{' '}
              {d.msg.challenge.modeLabel}
            </span>
          ) : (
            d.msg.text
          )}
      ...
      {/* Language picker */}
      <div style={{ fontSize: '.75rem', color: 'var(--text3)', marginBottom: 6 }}>
        {t('langpair.know')}:
      </div>
      ...
      {/* Category picker */}
      <div style={{ fontSize: '.75rem', color: 'var(--text3)', marginBottom: 5 }}>
        {t('duel.category')}
      </div>
      <div id="duel-cat-picker" style={{ marginBottom: 10 }}>
        <DuelCategoryPicker />
      </div>

      {/* Difficulty / Best of / Hints */}
      <div id="duel-options-row" style={{ marginBottom: 12 }}>
        <DuelOptionsRow />
      </div>
      ...
      <div id="duel-history-list" style={{ marginBottom: 14 }}>
        <DuelHistory />
      </div>
      ...
      {d.waiting.visible && (
        ...
        >
          <div style={{ fontSize: '.82rem', color: 'var(--text3)', marginBottom: 8 }}>
            {t('duel.shareCode')}
          </div>
          <div
            id="duel-room-code"
      ...
      {d.joinRowVisible && (
        <div>
          ...
          <div
            style={{ fontSize: '.72rem', color: 'var(--text3)', marginTop: 6, textAlign: 'center' }}
          >
            {t('duel.modeNote')}
          </div>
      ...
      {/* Divider */}
      <div style={{ height: 1, background: 'var(--border)', margin: '10px 0', opacity: 0.5 }}></div>
