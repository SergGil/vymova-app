    ...
    <div style={{ textAlign: 'center', padding: '20px 10px' }}>
      ...
      <div style={{ display: 'flex', gap: 20, justifyContent: 'center', alignItems: 'center' }}>
        <div style={{ textAlign: 'center' }}>
          ...
          <div
            style={{ fontSize: '1.8rem', fontWeight: 900, color: 'var(--accent)', margin: '4px 0' }}
          >
            {p1.score}
          </div>
          ...
          <div>
            <Dots idx={p1.idx} color="var(--accent)" />
          </div>
        </div>
        ...
        <div style={{ textAlign: 'center' }}>
          {p2 ? (
            <>
              ...
              <div>
                <Dots idx={p2.idx} color="var(--accent2)" />
              </div>
            </>
          ) : (
            <div style={{ color: 'var(--text3)', fontSize: '.82rem' }}>
              {t('duel.spectate.waitP2')}
            </div>
          )}
        </div>
      </div>
