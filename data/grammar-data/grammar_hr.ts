// Vymova — data/grammar-data/grammar_hr.ts
        ...
        "sections": [
          {
            ...
            "en": {
              "text": "Croatian verbs mark person through their ending, so the pronoun is often dropped in normal speech — much like in Ukrainian."
            }
          },
          {
            "type": "table",
        ...
        "sections": [
          {
            ...
            "en": {
              "text": "Croatian nouns, like Ukrainian ones, decline through seven cases — the ending shows a word's role in the sentence."
            }
          },
          {
            "type": "examples",
