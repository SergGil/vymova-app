...
export const ANTONYMS: Record<string, AntonymEntry[]> = {
  ...
  // ── Batch: media/academia/cooking/sports/emotions/nature/business/objects/travel/sensory/verbs (round H) ──
  published: [{ word: 'unpublished' }],
  censored: [{ word: 'uncensored' }],
  biased: [{ word: 'objective' }],
  sensational: [{ word: 'factual' }],
  credible: [{ word: 'dubious' }],
  'peer-reviewed': [{ word: 'unreviewed' }],
  plagiarized: [{ word: 'original' }],
  cited: [{ word: 'uncited' }],
  tenured: [{ word: 'untenured' }],
  accredited: [{ word: 'unaccredited' }],
  marinated: [{ word: 'plain' }],
  garnished: [{ word: 'plain' }],
  glazed: [{ word: 'matte' }],
  unbeaten: [{ word: 'beaten' }],
  relegated: [{ word: 'promoted' }],
  promoted: [{ word: 'relegated' }],
  benched: [{ word: 'starting' }],
  drafted: [{ word: 'undrafted' }],
  nostalgic: [{ word: 'indifferent' }],
  euphoric: [{ word: 'despondent' }],
  despondent: [{ word: 'euphoric' }],
  carefree: [{ word: 'burdened' }],
  burdened: [{ word: 'carefree' }],
  remorseful: [{ word: 'unrepentant' }],
  unrepentant: [{ word: 'remorseful' }],
  indignant: [{ word: 'content' }],
  homesick: [{ word: 'settled' }],
  gusty: [{ word: 'still-aired' }],
  audited: [{ word: 'unaudited' }],
  insured: [{ word: 'uninsured' }],
  collateralized: [{ word: 'unsecured' }],
  unsecured: [{ word: 'collateralized' }],
  reusable: [{ word: 'disposable' }],
  disposable: [{ word: 'reusable' }],
  recyclable: [{ word: 'nonrecyclable' }],
  durable: [{ word: 'disposable' }],
  handcrafted: [{ word: 'mass-produced' }],
  bespoke: [{ word: 'off-the-shelf' }],
  guided: [{ word: 'self-guided' }],
  chartered: [{ word: 'scheduled' }],
  refundable: [{ word: 'nonrefundable' }],
  transferable: [{ word: 'nontransferable' }],
  fragrant: [{ word: 'foul-smelling' }],
  glossy: [{ word: 'matte' }],
  translucent: [{ word: 'opaque' }],
  pungent: [{ word: 'mild-smelling' }],
  reconcile: [{ word: 'alienate' }],
  compensate: [{ word: 'shortchange' }],
  delegate: [{ word: 'micromanage' }],
  supervise: [{ word: 'neglect' }],
  streamline: [{ word: 'complicate' }],
  negotiate: [{ word: 'dictate' }],
};
