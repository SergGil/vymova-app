// Vymova — data/idioms-data/idioms_tet.ts
...
export const IDIOMS_TET: Idiom[] = [
  ...
  {
    "emoji": "⏳",
    "phrase": "Tempu iha folin boot",
    "meaning": "Час має велику цінність",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Tempu iha folin boot.",
  ...
  {
    "emoji": "🏛️",
    "phrase": "Roma la harii iha loron ida deit",
    "meaning": "Рим не за один день збудували",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Roma la harii iha loron ida deit.",
  ...
  {
    "emoji": "🧠",
    "phrase": "Ulun rua diak liu duke ida",
    "meaning": "Дві голови кращі за одну",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Ulun rua diak liu duke ida.",
  ...
  {
    "emoji": "🚪",
    "phrase": "Komesa hotu-hotu mak susar",
    "meaning": "Кожен початок важкий",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Komesa hotu-hotu mak susar.",
  ...
  {
    "emoji": "🥾",
    "phrase": "Pasu dahuluk mak susar liu",
    "meaning": "Перший крок найважчий",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Pasu dahuluk mak susar liu.",
  ...
  {
    "emoji": "💗",
    "phrase": "Laran diak folin boot liu duke osan",
    "meaning": "Добре серце цінніше за багатство",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Laran diak folin boot liu duke osan.",
  ...
  {
    "emoji": "😊",
    "phrase": "Ida neʼebé serbisu ho laran manán",
    "meaning": "Хто працює від серця, той досягає успіху",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Ida neʼebé serbisu ho laran manán.",
  ...
  {
    "emoji": "🌻",
    "phrase": "Diʼak-laran sempre fila fali",
    "meaning": "Щедрість завжди повертається",
    "exampleSrc": "Nuudar lia-fuan naʼin sira — Diʼak-laran sempre fila fali.",
