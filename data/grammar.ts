...

      {
        ...
        sections: [
          ...
          },
          {
            type: 'formula',
            title: 'Структура',
            rows: [['', 'Lo que + речення + es/era + ...', '→ Lo que necesito es tiempo.']],
            en: { title: 'Structure' },
          },
          {
            type: 'examples',
...

      {
        ...
        sections: [
          ...
          },
          {
            type: 'formula',
            title: 'Структура',
            rows: [['', 'sujet + ne + verbe + que + ...', "→ Je n'ai que deux euros."]],
            en: { title: 'Structure' },
          },
          {
            type: 'examples',
...

      {
        ...
        sections: [
          ...
          },
          {
            type: 'formula',
            title: 'Структура',
            rows: [['', 'sujet + ne + verbe + ni... ni...', "→ Je n'aime ni le café ni le thé."]],
            en: { title: 'Structure' },
          },
          {
            type: 'examples',
    ...
    rules: [
      {
        ...
        sections: [
          ...
          },
          {
            ...
            en: { title: 'Irregular Verbs (Infinitive — Simple Past — Past Participle)' },
            rows: [
              ['Infinitiv', 'Präteritum', 'Partizip II', 'Переклад'],
              ['backen', 'buk / backte', 'hat gebacken', 'пекти'],
              ...
              ['bersten', 'barst', 'ist geborsten', 'тріскати, лопатись'],
              ['biegen', 'bog', 'hat/ist gebogen', 'гнути(ся)'],
              ...
              ['braten', 'briet', 'hat gebraten', 'смажити'],
              ['brechen', 'brach', 'hat/ist gebrochen', 'ламати(ся)'],
              ['brennen', 'brannte', 'hat gebrannt', 'горіти'],
              ['bringen', 'brachte', 'hat gebracht', 'приносити'],
              ['denken', 'dachte', 'hat gedacht', 'думати'],
              ['dringen', 'drang', 'ist gedrungen', 'проникати'],
              ['dürfen', 'durfte', 'hat gedurft', 'мати дозвіл'],
              ['empfehlen', 'empfahl', 'hat empfohlen', 'рекомендувати'],
              ['erschrecken', 'erschrak', 'ist erschrocken', 'лякатися'],
              ['essen', 'aß', 'hat gegessen', 'їсти'],
              ['fahren', 'fuhr', 'ist gefahren', 'їхати'],
              ['fallen', 'fiel', 'ist gefallen', 'падати'],
              ['fangen', 'fing', 'hat gefangen', 'ловити'],
              ['finden', 'fand', 'hat gefunden', 'знаходити'],
              ['flechten', 'flocht', 'hat geflochten', 'плести'],
              ['fliegen', 'flog', 'ist geflogen', 'летіти'],
              ['fliehen', 'floh', 'ist geflohen', 'тікати'],
              ['fließen', 'floss', 'ist geflossen', 'текти'],
              ['fressen', 'fraß', 'hat gefressen', 'їсти (про тварин)'],
              ['frieren', 'fror', 'hat gefroren', 'мерзнути'],
              ['gebären', 'gebar', 'hat geboren', 'народжувати'],
              ['geben', 'gab', 'hat gegeben', 'давати'],
              ['gehen', 'ging', 'ist gegangen', 'йти'],
              ['gelingen', 'gelang', 'ist gelungen', 'вдаватися'],
              ['gelten', 'galt', 'hat gegolten', 'діяти, бути чинним'],
              ['genesen', 'genas', 'ist genesen', 'одужувати'],
              ['genießen', 'genoss', 'hat genossen', 'насолоджуватися'],
              ['geschehen', 'geschah', 'ist geschehen', 'ставатися'],
              ['gewinnen', 'gewann', 'hat gewonnen', 'вигравати'],
              ['gießen', 'goss', 'hat gegossen', 'лити, поливати'],
              ['gleichen', 'glich', 'hat geglichen', 'бути схожим'],
              ['gleiten', 'glitt', 'ist geglitten', 'ковзати'],
              ['graben', 'grub', 'hat gegraben', 'копати'],
              ['greifen', 'griff', 'hat gegriffen', 'хапати'],
              ['haben', 'hatte', 'hat gehabt', 'мати'],
              ['halten', 'hielt', 'hat gehalten', 'тримати, зупинятися'],
              ['hängen', 'hing', 'hat gehangen', 'висіти'],
              ['hauen', 'hieb / haute', 'hat gehauen', 'бити, рубати'],
              ['heben', 'hob', 'hat gehoben', 'піднімати'],
              ['heißen', 'hieß', 'hat geheißen', 'називатися'],
              ['helfen', 'half', 'hat geholfen', 'допомагати'],
              ['kennen', 'kannte', 'hat gekannt', 'знати (когось)'],
              ['klingen', 'klang', 'hat geklungen', 'звучати'],
              ['kneifen', 'kniff', 'hat gekniffen', 'щипати'],
              ['kommen', 'kam', 'ist gekommen', 'приходити'],
              ['können', 'konnte', 'hat gekonnt', 'могти, вміти'],
              ['kriechen', 'kroch', 'ist gekrochen', 'повзати'],
              ['laden', 'lud', 'hat geladen', 'вантажити, запрошувати'],
              ['lassen', 'ließ', 'hat gelassen', 'дозволяти, залишати'],
              ['laufen', 'lief', 'ist gelaufen', 'бігти'],
              ['leiden', 'litt', 'hat gelitten', 'страждати'],
              ['leihen', 'lieh', 'hat geliehen', 'позичати'],
              ['lesen', 'las', 'hat gelesen', 'читати'],
              ['liegen', 'lag', 'hat gelegen', 'лежати'],
              ['lügen', 'log', 'hat gelogen', 'брехати'],
              ['meiden', 'mied', 'hat gemieden', 'уникати'],
              ['messen', 'maß', 'hat gemessen', 'вимірювати'],
              ['mögen', 'mochte', 'hat gemocht', 'любити, подобатися'],
              ['müssen', 'musste', 'hat gemusst', 'бути зобов\'язаним'],
              ['nehmen', 'nahm', 'hat genommen', 'брати'],
              ['nennen', 'nannte', 'hat genannt', 'називати'],
              ['pfeifen', 'pfiff', 'hat gepfiffen', 'свистіти'],
              ['preisen', 'pries', 'hat gepriesen', 'вихваляти'],
              ['raten', 'riet', 'hat geraten', 'радити, вгадувати'],
              ['reiben', 'rieb', 'hat gerieben', 'терти'],
              ['reißen', 'riss', 'hat/ist gerissen', 'рвати(ся)'],
              ['reiten', 'ritt', 'ist geritten', 'їздити верхи'],
              ['rennen', 'rannte', 'ist gerannt', 'бігти'],
              ['riechen', 'roch', 'hat gerochen', 'пахнути'],
              ['ringen', 'rang', 'hat gerungen', 'боротися'],
              ['rufen', 'rief', 'hat gerufen', 'кликати'],
              ['salzen', 'salzte', 'hat gesalzen', 'солити'],
              ['saufen', 'soff', 'hat gesoffen', 'пити (про тварин; жарг.)'],
              ['saugen', 'sog / saugte', 'hat gesogen', 'смоктати, всмоктувати'],
              ['schaffen', 'schuf', 'hat geschaffen', 'створювати'],
              ['scheiden', 'schied', 'hat/ist geschieden', 'розлучатися, розділяти'],
              ...
              ['schlagen', 'schlug', 'hat geschlagen', 'бити'],
              ['schleichen', 'schlich', 'ist geschlichen', 'підкрадатися'],
              ['schleifen', 'schliff', 'hat geschliffen', 'гострити, шліфувати'],
              ['schließen', 'schloss', 'hat geschlossen', 'закривати'],
              ['schlingen', 'schlang', 'hat geschlungen', 'обвивати'],
              ['schmeißen', 'schmiss', 'hat geschmissen', 'кидати (розм.)'],
              ...
              ['schwellen', 'schwoll', 'ist geschwollen', 'набрякати'],
              ['schwimmen', 'schwamm', 'ist geschwommen', 'плавати'],
              ['schwingen', 'schwang', 'hat geschwungen', 'розмахувати'],
              ['schwören', 'schwor', 'hat geschworen', 'присягатися'],
              ['sehen', 'sah', 'hat gesehen', 'бачити'],
              ['sein', 'war', 'ist gewesen', 'бути'],
              ['senden', 'sandte', 'hat gesandt', 'надсилати'],
              ['singen', 'sang', 'hat gesungen', 'співати'],
              ['sinken', 'sank', 'ist gesunken', 'тонути, опускатися'],
              ['sinnen', 'sann', 'hat gesonnen', 'розмірковувати'],
              ['sitzen', 'saß', 'hat gesessen', 'сидіти'],
              ['sollen', 'sollte', 'hat gesollt', 'бути повинним'],
              ['spinnen', 'spann', 'hat gesponnen', 'прясти, вигадувати'],
              ['sprechen', 'sprach', 'hat gesprochen', 'говорити'],
              ['springen', 'sprang', 'ist gesprungen', 'стрибати'],
              ['stechen', 'stach', 'hat gestochen', 'колоти'],
              ['stehen', 'stand', 'hat gestanden', 'стояти'],
              ['stehlen', 'stahl', 'hat gestohlen', 'красти'],
              ['steigen', 'stieg', 'ist gestiegen', 'підійматися'],
              ['sterben', 'starb', 'ist gestorben', 'помирати'],
              ['stinken', 'stank', 'hat gestunken', 'смердіти'],
              ['stoßen', 'stieß', 'hat/ist gestoßen', 'штовхати, наштовхуватися'],
              ['streichen', 'strich', 'hat gestrichen', 'фарбувати, гладити'],
              ['streiten', 'stritt', 'hat gestritten', 'сваритися'],
              ['tragen', 'trug', 'hat getragen', 'нести, носити'],
              ['treffen', 'traf', 'hat getroffen', 'зустрічати'],
              ['treiben', 'trieb', 'hat/ist getrieben', 'гнати, займатися'],
              ['treten', 'trat', 'hat/ist getreten', 'ступати, штовхати ногою'],
              ['trinken', 'trank', 'hat getrunken', 'пити'],
              ['tun', 'tat', 'hat getan', 'робити'],
              ['verderben', 'verdarb', 'hat/ist verdorben', 'псувати(ся)'],
              ['vergessen', 'vergaß', 'hat vergessen', 'забувати'],
              ['verlieren', 'verlor', 'hat verloren', 'втрачати'],
              ['wachsen', 'wuchs', 'ist gewachsen', 'рости'],
              ['waschen', 'wusch', 'hat gewaschen', 'мити'],
              ['weichen', 'wich', 'ist gewichen', 'відступати, поступатися'],
              ['weisen', 'wies', 'hat gewiesen', 'вказувати'],
              ['wenden', 'wandte', 'hat gewandt', 'повертати(ся)'],
              ['werben', 'warb', 'hat geworben', 'рекламувати, вербувати'],
              ['werden', 'wurde', 'ist geworden', 'ставати'],
              ['werfen', 'warf', 'hat geworfen', 'кидати'],
              ['wiegen', 'wog', 'hat gewogen', 'важити'],
              ['wissen', 'wusste', 'hat gewusst', 'знати (факт)'],
              ['wollen', 'wollte', 'hat gewollt', 'хотіти'],
              ['ziehen', 'zog', 'hat/ist gezogen', 'тягнути, переїжджати'],
              ['zwingen', 'zwang', 'hat gezwungen', 'примушувати'],            ],
          },
          {
            type: 'note',
      ...
      },
      {
        ...
        sections: [
          ...
          },
          {
            ...
            en: { title: 'Separable Verbs' },
            rows: [
              ['Дієслово', 'Значення', 'Приклад'],
              ['aufstehen', 'вставати', 'Ich stehe um sieben Uhr auf.'],
              ['ankommen', 'прибувати', 'Der Zug kommt um acht an.'],
              ['anrufen', 'телефонувати', 'Ich rufe dich später an.'],
              ['aufmachen', 'відкривати', 'Mach das Fenster auf!'],
              ['zumachen', 'закривати', 'Mach die Tür zu!'],
              ['einkaufen', 'робити покупки', 'Wir kaufen heute ein.'],
              ['ausgehen', 'виходити (розважатися)', 'Wir gehen heute Abend aus.'],
              ['mitkommen', 'йти разом', 'Kommst du mit?'],
              ['mitbringen', 'приносити з собою', 'Bring bitte etwas zu essen mit.'],
              ['wegfahren', 'виїжджати', 'Wir fahren am Montag weg.'],
              ['zurückkommen', 'повертатися', 'Er kommt morgen zurück.'],
              ['zurückgeben', 'повертати (річ)', 'Gib mir das Buch zurück.'],
              ['vorbereiten', 'готувати(ся)', 'Ich bereite mich auf die Prüfung vor.'],
              ['vorstellen', 'представляти', 'Ich stelle dir meinen Freund vor.'],
              ['aufwachen', 'прокидатися', 'Ich wache jeden Morgen früh auf.'],
              ['einschlafen', 'засинати', 'Das Baby schläft schnell ein.'],
              ['anfangen', 'починати', 'Der Film fängt um acht an.'],
              ['aufhören', 'припиняти', 'Hör auf zu reden!'],
              ['mitmachen', 'брати участь', 'Machst du mit?'],
              ['teilnehmen', 'брати участь', 'Ich nehme an dem Kurs teil.'],
              ['ausschalten', 'вимикати', 'Schalte das Licht aus.'],
              ['einschalten', 'вмикати', 'Schalte den Fernseher ein.'],
              ['anziehen', 'одягати', 'Zieh deine Jacke an.'],
              ['ausziehen', 'роздягатися, виїжджати', 'Zieh deine Schuhe aus.'],
              ['aufräumen', 'прибирати', 'Ich räume mein Zimmer auf.'],
              ['wegwerfen', 'викидати', 'Wirf den Müll weg.'],
              ['mitnehmen', 'брати з собою', 'Nimm einen Regenschirm mit.'],
              ['abholen', 'забирати (когось)', 'Ich hole dich vom Bahnhof ab.'],
              ['absagen', 'скасовувати', 'Sie sagt das Treffen ab.'],
              ['zusagen', 'погоджуватися', 'Er sagt der Einladung zu.'],
              ['vorschlagen', 'пропонувати', 'Ich schlage einen Ausflug vor.'],
              ['durchführen', 'проводити (захід)', 'Sie führen das Experiment durch.'],
              ['feststellen', 'встановлювати, з\'ясовувати', 'Wir stellen das Problem fest.'],
              ['festhalten', 'міцно тримати', 'Halt dich fest!'],
              ['loslassen', 'відпускати', 'Lass mich los!'],
              ['losgehen', 'вирушати, починатися', 'Wann geht die Party los?'],
              ['umziehen', 'переїжджати, переодягатися', 'Wir ziehen nächsten Monat um.'],
              ['umsteigen', 'пересідати (транспорт)', 'Sie steigen in Berlin um.'],
              ['weitermachen', 'продовжувати', 'Mach weiter!'],
              ['zusammenpassen', 'пасувати одне одному', 'Die Farben passen gut zusammen.'],
              ['zusammenarbeiten', 'співпрацювати', 'Wir arbeiten gut zusammen.'],
              ['hinfallen', 'падати', 'Das Kind ist hingefallen.'],
              ['hingehen', 'йти туди', 'Wo gehst du hin?'],
              ['herkommen', 'приходити сюди', 'Komm her!'],
              ['hereinkommen', 'заходити', 'Komm herein!'],
              ['hinausgehen', 'виходити', 'Er geht hinaus.'],
              ['ausdrucken', 'роздруковувати', 'Ich drucke das Dokument aus.'],
              ['ausfüllen', 'заповнювати (форму)', 'Füllen Sie das Formular aus.'],
              ['anmelden', 'реєструвати(ся)', 'Ich melde mich für den Kurs an.'],
              ['abmelden', 'виписуватися, відписуватися', 'Ich melde mich vom Newsletter ab.'],
              ['anbieten', 'пропонувати (товар/послугу)', 'Wir bieten einen Rabatt an.'],
              ['annehmen', 'приймати', 'Ich nehme das Angebot an.'],
              ['ablehnen', 'відхиляти', 'Sie lehnt den Vorschlag ab.'],
              ['abschließen', 'завершувати, замикати', 'Ich schließe die Tür ab.'],
              ['aufpassen', 'слідкувати, бути уважним', 'Pass auf!'],
              ['aufwachsen', 'зростати', 'Er ist in Berlin aufgewachsen.'],
              ['ausruhen', 'відпочивати', 'Ich ruhe mich aus.'],
              ['aussehen', 'виглядати', 'Du siehst müde aus.'],
              ['aussteigen', 'виходити (з транспорту)', 'Ich steige an der nächsten Haltestelle aus.'],
              ['einsteigen', 'заходити (в транспорт)', 'Steig schnell ein!'],
              ['eintragen', 'вписувати', 'Trag deinen Namen ein.'],
              ['einladen', 'запрошувати', 'Ich lade dich zur Party ein.'],
              ['einziehen', 'в\'їжджати (в житло)', 'Wir ziehen nächste Woche ein.'],
              ['mitteilen', 'повідомляти', 'Ich teile dir die Neuigkeit mit.'],
              ['nachdenken', 'розмірковувати', 'Ich denke über das Problem nach.'],
              ['nachschauen', 'перевіряти, дивитися', 'Schau bitte nach, ob die Tür zu ist.'],
              ['nachholen', 'надолужувати', 'Ich muss die Arbeit nachholen.'],
              ['vorbeikommen', 'заходити (в гості)', 'Komm doch mal vorbei!'],
              ['vorbeigehen', 'проходити повз', 'Ich gehe an dem Laden vorbei.'],
              ['vorlesen', 'читати вголос', 'Die Mutter liest dem Kind vor.'],
              ['vorziehen', 'надавати перевагу', 'Ich ziehe Tee vor.'],
              ['weggehen', 'йти геть', 'Geh nicht weg!'],
              ['wegnehmen', 'забирати', 'Nimm mir das nicht weg!'],
              ['weiterfahren', 'їхати далі', 'Wir fahren weiter.'],
              ['weitergehen', 'йти далі', 'Das Leben geht weiter.'],
              ['zunehmen', 'набирати вагу', 'Ich habe fünf Kilo zugenommen.'],
              ['abnehmen', 'худнути, знімати (слухавку)', 'Ich möchte abnehmen.'],
              ['zuhören', 'слухати', 'Hör mir bitte zu!'],
              ['zusehen', 'спостерігати', 'Ich sehe ihm beim Kochen zu.'],
              ['zurückkehren', 'повертатися', 'Er kehrt nach Hause zurück.'],
              ['zurückrufen', 'передзвонити', 'Ich rufe dich zurück.'],
              ['abfahren', 'відправлятися (транспорт)', 'Der Bus fährt in fünf Minuten ab.'],
              ['abfliegen', 'вилітати', 'Das Flugzeug fliegt um zehn ab.'],
              ['abgeben', 'здавати', 'Ich gebe die Prüfung ab.'],
              ['absteigen', 'злазити, зупинятися (в готелі)', 'Wir steigen im Hotel ab.'],
              ['anbauen', 'вирощувати, добудовувати', 'Die Bauern bauen Weizen an.'],
              ['anbrennen', 'підгоряти', 'Das Essen ist angebrannt.'],
              ['andauern', 'тривати', 'Der Regen dauert an.'],
              ['anfassen', 'торкатися', 'Fass das nicht an!'],
              ['angeben', 'хвалитися, вказувати', 'Gib bitte deine Adresse an.'],
              ['angehen', 'стосуватися, вмикатися', 'Das geht dich nichts an.'],
              ['anhalten', 'зупиняти(ся)', 'Der Bus hält an.'],
              ['ankreuzen', 'позначати галочкою', 'Kreuzen Sie die richtige Antwort an.'],
              ['anlegen', 'вкладати (гроші), одягати', 'Sie legt Geld an.'],
              ['anmachen', 'вмикати, чіплятися', 'Mach das Radio an.'],
              ['anpassen', 'пристосовувати', 'Wir passen den Plan an.'],
              ['anschauen', 'дивитися на', 'Schau mich an.'],
              ['ansehen', 'розглядати, вважати', 'Ich sehe mir das Bild an.'],
              ['anspringen', 'заводитися (двигун)', 'Das Auto springt nicht an.'],
              ['anstellen', 'наймати на роботу, вмикати', 'Die Firma stellt neue Mitarbeiter an.'],
              ['auffallen', 'привертати увагу', 'Ihr Kleid fällt auf.'],
              ['aufgeben', 'здаватися, здавати (пошту)', 'Gib nicht auf!'],
              ['aufhalten', 'затримувати', 'Halt mich nicht auf.'],
              ['aufholen', 'надолужувати (втрачений час)', 'Wir müssen die Zeit aufholen.'],
              ['auflösen', 'розчиняти, розпускати', 'Der Zucker löst sich auf.'],
              ['aufnehmen', 'записувати (звук), приймати', 'Wir nehmen das Konzert auf.'],
              ['aufschlagen', 'розкривати (книгу), розбивати', 'Schlag das Buch auf Seite zehn auf.'],
              ['aufsetzen', 'надягати (окуляри)', 'Setz deine Brille auf.'],
              ['aufsteigen', 'підійматися', 'Der Ballon steigt auf.'],
              ['auftauchen', 'з\'являтися', 'Er ist plötzlich aufgetaucht.'],
              ['auftreten', 'виступати, з\'являтися', 'Sie tritt heute Abend auf.'],
              ['aufwenden', 'витрачати (зусилля/гроші)', 'Wir wenden viel Zeit auf.'],
              ['ausbauen', 'розширювати, добудовувати', 'Wir bauen das Haus aus.'],
              ['ausbilden', 'навчати (профосвіта)', 'Die Firma bildet Lehrlinge aus.'],
              ['ausbrechen', 'вибухати, вириватися', 'Der Krieg brach aus.'],
              ['ausdenken', 'вигадувати', 'Sie denkt sich eine Geschichte aus.'],
              ['ausdrücken', 'виражати', 'Drück deine Gefühle aus.'],
              ['auseinandergehen', 'розходитися', 'Die Meinungen gehen auseinander.'],
              ['ausgeben', 'витрачати (гроші)', 'Ich gebe zu viel Geld aus.'],
              ['ausgleichen', 'компенсувати, вирівнювати', 'Das gleicht die Differenz aus.'],
              ['aushalten', 'витримувати', 'Ich halte das nicht mehr aus.'],
              ['auskommen', 'обходитися, ладнати', 'Wir kommen gut miteinander aus.'],
              ['auspacken', 'розпаковувати', 'Ich packe den Koffer aus.'],
              ['ausrichten', 'передавати (повідомлення)', 'Ich richte ihm das aus.'],
              ['ausschließen', 'виключати', 'Wir schließen diese Möglichkeit aus.'],
              ['aussprechen', 'вимовляти', 'Sprich das Wort richtig aus.'],
              ['ausstellen', 'виставляти (експонат)', 'Das Museum stellt Gemälde aus.'],
              ['austauschen', 'обмінюватися', 'Wir tauschen Nummern aus.'],
              ['austeilen', 'роздавати', 'Der Lehrer teilt die Blätter aus.'],
              ['auswählen', 'вибирати', 'Wähl ein Buch aus.'],
              ['auswandern', 'емігрувати', 'Sie sind nach Kanada ausgewandert.'],
              ['auswirken', 'впливати', 'Das wirkt sich auf die Wirtschaft aus.'],
              ['bereitstellen', 'надавати, готувати', 'Die Stadt stellt Mittel bereit.'],
              ['beitragen', 'сприяти', 'Das trägt zum Erfolg bei.'],
              ['dabeihaben', 'мати при собі', 'Hast du dein Handy dabei?'],
              ['dazugehören', 'належати до', 'Das gehört dazu.'],
              ['durchlesen', 'прочитувати повністю', 'Lies den Text durch.'],
              ['durchsetzen', 'домагатися свого', 'Er setzt sich immer durch.'],
              ['eingreifen', 'втручатися', 'Die Polizei greift ein.'],
              ['einrichten', 'облаштовувати (квартиру)', 'Wir richten die Wohnung ein.'],
              ['einsetzen', 'застосовувати, вставляти', 'Wir setzen neue Technik ein.'],
              ['entgegenkommen', 'йти назустріч', 'Er kommt mir entgegen.'],
              ['festlegen', 'визначати, встановлювати', 'Wir legen den Termin fest.'],
              ['freilassen', 'звільняти, відпускати', 'Sie lassen den Vogel frei.'],
              ['gutmachen', 'виправити, компенсувати', 'Ich mache den Fehler gut.'],
              ['herausfinden', 'з\'ясовувати', 'Wir finden die Wahrheit heraus.'],
              ['hervorheben', 'підкреслювати', 'Ich möchte einen Punkt hervorheben.'],
              ['zurücklegen', 'відкладати (гроші, відстань)', 'Ich lege jeden Monat Geld zurück.'],
              ['nachmachen', 'наслідувати, повторювати', 'Mach mir das nach.'],
              ['vorkommen', 'траплятися', 'Das kommt oft vor.'],            ],
          },
        ],
      },
      {
    ...
    rules: [
      {
        ...
        sections: [
          ...
          },
          {
            ...
            rows: [
              ['tôi', 'я (нейтральне, ввічливе)'],
              ['bạn', 'ти / ви (до ровесника)'],
              ['anh', 'він / ти (старший чоловік)'],
              ['chị', 'вона / ти (старша жінка)'],
              ['chúng tôi', 'ми (без співрозмовника)'],
              ['họ', 'вони'],
            ],
          },
          {
            ...
            rows: [
              ...
              ['Bạn khỏe không?', 'Як ти? (букв. Ти здоровий?)'],
            ],
          },
        ],
      },

      {
        ...
        sections: [
          ...
          },
          {
            ...
            title: 'S + là + іменник',
            rows: [
              ['Tôi', 'là', 'giáo viên. (Я вчитель.)'],
              ['Đây', 'là', 'sách. (Це книга.)'],
              ['Cô ấy', 'là', 'bác sĩ. (Вона лікар.)'],
            ],
          },
          {
            type: 'examples',
            ...
            en: { title: 'Examples' },
            rows: [
              ['Anh ấy là bạn tôi.', 'Він мій друг.'],
...

      {
        ...
        sections: [
          ...
          },
          {
            ...
            rows: [
              ['không + дієслово/прикметник', 'không biết (не знаю), không lớn (не великий)'],
              ['không phải là + іменник', 'không phải là bác sĩ (не лікар)'],
            ],
          },
          {
            type: 'examples',
            ...
            rows: [
              ...
              ['Đây không phải là xe của tôi.', 'Це не моя машина.'],
            ],
          },
        ],
      },

      {
        ...
        sections: [
          ...
          },
          {
            ...
            rows: [
              ['Bạn', 'có khỏe không?', '(Ти здоровий? / Як справи?)'],
              ['Anh ấy', 'có đi không?', '(Він іде?)'],
            ],
          },
          {
            type: 'examples',
            ...
            en: { title: 'Examples' },
            rows: [
              ['Bạn có khỏe không? — Có, tôi khỏe.', 'Як ти? — Так, я здоровий.'],
              ['Chị có bận không? — Không, tôi không bận.', 'Ти зайнята? — Ні, я не зайнята.'],
            ],
          },
        ],
      },

      {
        ...
        sections: [
          ...
          },
          {
            ...
            rows: [
              ['cái', 'неживі предмети — cái bàn (стіл)'],
              ['con', 'тварини/істоти — con mèo (кіт)'],
              ['quả / trái', 'круглі плоди — quả cam (апельсин)'],
              ['chiếc', 'транспорт, парні предмети — chiếc xe (машина)'],
            ],
          },
          {
            type: 'examples',
            ...
            en: { title: 'Examples' },
            rows: [
              ['Tôi có một con mèo.', 'У мене є кіт.'],
              ['Đây là quả cam.', 'Це апельсин.'],
            ],
          },
        ],
      },
